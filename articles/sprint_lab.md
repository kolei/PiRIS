...
1. На сервере **mysql** кодировка баз по-умолчанию *latin*, перед созданием своих таблиц поменяйте на *utf8mb4* (либо при создании таблиц указывайте эту кодировку).
