...
В АПИ, разработанный в рамках прошлого задания, добавить __Basic__ авторизацию и аутентификацию, чтобы запрсы редактирования и удаления были доступны только администратору
