...
#### Лекции
1. [Основные понятия и определения ИС.](/articles/5_1_1_1_intro.md)<div style="display:none">
2+0</div>

2. Жизненный цикл информационных систем.<div style="display:none">
2+0 => 4+0 </div>

3. Организация и методы сбора информации. Анализ предметной области. Основные понятия системного и структурного анализа.
